...
from models.tts.fastspeech2.blocks.utils import LinearNorm, Swish, GLU
...
class Encoder(nn.Module):
    ...
    def __init__(self,
        ...
        d_model = hidden_dim
        f_factor = self.config["ffn_expansion_factor"]
        c_factor = self.config["conv_expansion_factor"]
        kernel_size = self.config["conv_kernel_size"]
        half_step_residual = self.config["half_step_residual"]
...
### Code building copy and modify from: https://github.com/sooftware/conformer ###
